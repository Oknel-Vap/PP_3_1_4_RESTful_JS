const url1 ='http://localhost:8080/admin/user'
const url2 ='http://localhost:8080/admin/allUsers'
const url3 ='http://localhost:8080/admin/'
const url4 ='http://localhost:8080/admin/create'
const url5 ='http://localhost:8080/admin/update'
...
on(document, 'click', '.eBtn', e => {
    ...
    const usernameEditModal = lineEdit.children[3].innerHTML
...
on(document, 'click', '.dBtn', e => {
    ...
    const usernameDeleteModal = lineDelete.children[3].innerHTML
